        ...
        <div className="container text-center space-y-content">
          <div className="space-y-element max-w-4xl mx-auto">
            <h3 className="text-4xl md:text-5xl font-bold text-gray-900 dark:text-gray-100">
              See SIE Wellness in Action
            </h3>
            <div className="space-y-4">
              <p className="text-xl text-gray-700 dark:text-gray-300">
                Watch how our AI-powered healthcare discovery platform helps you find 
                the right care quickly and easily, no matter your situation.
              </p>
            </div>
          </div>
          ...
          <div className="max-w-4xl mx-auto mt-12" ref={videoRef}>
            <div className="relative rounded-3xl overflow-hidden shadow-2xl bg-gradient-to-br from-gray-100 to-gray-200 dark:from-gray-800 dark:to-gray-900">
              <div className="relative w-full" style={{ height: "450px" }}>
                {!shouldLoadVideo ? (
                  ...
                  <>
                    {/* Show skeleton until video loads */}
                    {!videoLoaded && (
                      <div className="absolute inset-0 w-full h-full flex items-center justify-center bg-gray-100 dark:bg-gray-800 z-10">
                        <div className="text-center space-y-4">
                          <div className="w-16 h-16 mx-auto rounded-full bg-gray-200 dark:bg-gray-700 animate-pulse" />
                    ...
                    {/* Use video instead of GIF for better performance */}
                    <video
                      autoPlay
                      loop
                      muted
            ...
            <div className="mt-8 text-center">
              <p className="text-base text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
                Experience how SIE Wellness simplifies healthcare access with intelligent search, 
                comprehensive filtering, and real-time provider information.
              </p>
            </div>
          </div>
        </div>
