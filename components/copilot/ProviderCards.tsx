          ...
          {items.map((p) => {
            ...
            return (
              <article
                ...
                role="button"
                aria-label={`${p.name} details`}
                className="snap-start min-w-[85%] rounded-lg border border-gray-200 dark:border-gray-800 bg-white/80 dark:bg-gray-900/60 p-3 shadow-sm hover:shadow-md hover:-translate-y-[1px] transition-all cursor-pointer focus:outline-none"
              >
              <div className="flex items-start gap-2.5">
                <div className="flex-1 min-w-0">
                  <div className="flex items-center justify-between gap-2">
